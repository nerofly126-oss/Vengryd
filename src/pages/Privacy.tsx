...
// Privacy Policy page (route: /privacy) — static legal copy for the marketplace.
...
// Titled content block for one numbered privacy section.
...
/** Privacy page: renders the Privacy Policy sections inside LegalShell. */
const Privacy = () => {
  return (
